...
@Service
@Slf4j
public class MetricsTagServiceImpl implements MetricsTagService {

    @Override
    public List<String> getCommonTagsKeys() {
        return Arrays.asList("application", "serverIp", "serverEnv", "serverEnvId");
    }
