...
// * peer helper
// *
// * <p>code rule: all public static method must use SpanHolder rather than TSpanData or TAttributes
// */
//@Slf4j
...
//        String dbSystem = spanHolder.getAttribute(SemanticAttributes.DB_SYSTEM.getKey());
//        if (dbSystem != null) {
...
//        }
//
//        String portStr = spanHolder.getAttribute(SemanticAttributes.NET_PEER_PORT.getKey());
...
//        }
//
//        String messagingSystem = spanHolder.getAttribute(SemanticAttributes.MESSAGING_SYSTEM.getKey());
...
//        String name = spanHolder.getAttribute(SemanticAttributes.NET_PEER_NAME.getKey());
//        String ip = spanHolder.getAttribute(SemanticAttributes.NET_PEER_IP.getKey());
//        String host = spanHolder.getAttribute(SemanticAttributes.HTTP_HOST.getKey());
//        int port = 0;
//        if (spanHolder.hasAttribute(SemanticAttributes.NET_PEER_PORT.getKey())) {
//            try {
//                port =
//                        Integer.parseInt(
//                                spanHolder.getAttribute(SemanticAttributes.NET_PEER_PORT.getKey()));
//            } catch (NumberFormatException ex) {
//                log.debug("service {} has wrong port format, port is {}", spanHolder.getService(), spanHolder.getAttribute(SemanticAttributes.NET_PEER_PORT.getKey()));
//            }
//        }
//
...
//        return spanHolder
//                .getAttributeMap()
//                .getOrDefault(SemanticAttributes.MESSAGING_DESTINATION.getKey(), "unknown");
//    }
//
